...
public class Main {
	...
	public static void main(String[] args) {
		...
		// doy a atributo puntuacionJugador1 valor igual al valor devuelto por funcion
		// sacaSuma
		FuncionesEj2.puntuacionJugador1 = FuncionesEj2.sacaSuma();

		// compruebo si valor de puntuacionJugador1 es igual o menor a 7,5 con funcion
		// menor8
		...
		// compruebo si valor de puntuacionJugador2 es igual o menor a 7,5 con funcion
		// menor8
